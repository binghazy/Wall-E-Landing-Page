...
const testimonials = [
  {
    quote:
      "Nested documents, live sync, and Gemini assistance made WALL-E our default workspace in one week.",
    author: "Emma Wilson",
    role: "Product Manager",
    company: "Northstar",
    metric: { value: "7 days", label: "to team rollout" },
  },
  {
    quote:
      "Publishing read-only links is effortless, and the trash system gives our team real confidence when editing fast.",
    author: "Alex Turner",
    role: "Technical Lead",
    company: "Beacon Labs",
    metric: { value: "1-click", label: "client sharing" },
  },
  {
    quote:
      "Guest mode let us pilot with zero setup. People could write, search, and share immediately.",
    author: "Sarah Mitchell",
    role: "Operations Manager",
    company: "Field Notes",
    metric: { value: "0", label: "required logins" },
  },
  {
    quote:
      "BlockNote editing feels fast, the cover images look great, and restore flows saved a launch doc we thought was gone.",
    author: "John Park",
    role: "Co-founder",
    company: "Launchpad",
    metric: { value: "12", label: "docs restored" },
  },
];
...
export function TestimonialsSection() {
  ...
  useEffect(() => {
    // Generate ASCII background only on client to avoid SSR mismatch
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="flex items-center justify-between mb-20">
          <div>
            ...
            >
              Trusted by teams
              <span className="text-background/40"> building fast.</span>
            </h2>
          </div>
          ...
          <div className="lg:col-span-7 relative">
            ...
            <div className="relative">
              ...
              <div className="mt-12 flex items-center gap-6">
                <div className="size-12 rounded-full bg-background/10 flex items-center justify-center shrink-0">
