...
const securityFeatures = [
  {
    ...
    description:
      "Verify protected actions before users reach personal or shared documents.",
  ...
  },
  {
    ...
    description:
      "Control who can create, edit, archive, publish, and restore content.",
  ...
  },
  {
    ...
    description:
      "Publish safe preview links without exposing editing controls.",
  ...
  },
  {
    ...
    description:
      "Trash filtering, restore flows, and permanent delete keep cleanup intentional.",
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20">
          ...
          <h2
            ...
            Secure,
            <br />
            <span className="text-muted-foreground">without friction.</span>
          </h2>
          ...
          >
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              WALL-E combines authentication, permissions, safe sharing, and
              recovery controls so teams can collaborate confidently.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="mt-8">
                <span className="text-7xl lg:text-8xl font-display">JWT</span>
                <span className="block text-muted-foreground mt-2">
                  Verified identity before every protected workspace action
                </span>
              </div>
            </div>
