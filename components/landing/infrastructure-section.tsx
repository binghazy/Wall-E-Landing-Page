...
const regions = [
  { name: "Nested Documents", detail: "Infinite levels", status: "ready" },
  { name: "AI Assistant", detail: "Gemini 2.5 Flash", status: "live" },
  { name: "Publishing", detail: "Read-only preview links", status: "ready" },
  { name: "Guest Mode", detail: "Local persistence", status: "available" },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20">
          ...
          <div className="grid lg:grid-cols-[auto_1fr] gap-12 lg:gap-16 items-center">
            {/* Brand mark */}
            <div
              className={`relative z-[99] w-64 md:w-80 lg:w-96 xl:w-[450px] shrink-0 transition-all duration-1000 ${
                isVisible
            ...
            <div className="flex flex-col">
              <h2
                className={`text-5xl md:text-6xl lg:text-[100px] font-display font-bold tracking-tight leading-[0.9] transition-all duration-1000 ${
                  isVisible
              ...
              <p
                className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-2xl transition-all duration-1000 delay-100 ${
                  isVisible ? "opacity-100" : "opacity-0"
                }`}
              >
                WALL-E combines nested documents, BlockNote editing, Gemini
                assistance, Convex sync, Clerk auth, EdgeStore uploads, and
                guest mode in one production-ready workspace.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground max-w-md">
                Documents, editor, AI, auth, sync, storage, publishing, trash
                recovery, guest mode, and polished UX in one flow.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              <span className="text-5xl lg:text-6xl font-display">Cmd+K</span>
              <span className="block text-sm text-muted-foreground mt-2">
                Instant search
              </span>
            </div>
