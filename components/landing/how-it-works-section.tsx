...
const steps = [
  {
    number: "01",
    title: "Capture",
    subtitle: "your structure",
    description:
      "Create your first document, nest pages infinitely, add icons and cover images, and organize work the way your team actually thinks.",
    code: `const workspace = await wallE.createWorkspace({
  name: 'Product Docs',
  theme: 'system',
  guestMode: true,
  search: true
  ...
  },
  {
    ...
    subtitle: "AI assist",
    description:
      "Draft in BlockNote, edit titles inline, drop in checklists and tables, and ask Gemini to stream answers or insert content for you.",
    code: `const doc = await workspace.createDocument({
  title: 'Q2 Launch Brief',
  icon: '🚀',
  coverImage: true,
  blocks: ['paragraph', 'checklist', 'table']
})`,
  },
  {
    number: "03",
    ...
    subtitle: "recover",
    description:
      "Share read-only URLs, unpublish anytime, and use trash plus restore flows to recover archived content without losing momentum.",
    code: `const shareLink = await doc.publish({
  readOnly: true,
  copyUrl: true,
  preview: true,
  reversible: true
})
// Restore later with one click if plans change`,
  },
];
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            >
              ...
              <span className="block text-white/30">Write.</span>
