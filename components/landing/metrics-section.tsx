...
const metrics = [
  {
    ...
    prefix: "",
    label: "Core features",
    sublabel: "documents, AI, auth, sync, and publishing",
  },
  {
    value: 100,
    suffix: "%",
    ...
    sublabel: "titles, content, and metadata",
  },
  {
    value: 1,
    suffix: "-click",
    ...
    sublabel: "share a read-only preview URL",
  },
];
...
function DotGraph({
  ...
  useEffect(() => {
    // Initialize random phase on client to avoid SSR mismatch
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="lg:col-span-8 lg:col-start-1">
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-sm font-mono text-muted-foreground">
                {time ? `${time.toLocaleTimeString("en-GB")} local time` : ""}
              </span>
            </div>
            ...
            >
              Live
              <br />
              <span className="text-muted-foreground">workspace signals.</span>
            </h2>
          </div>
        </div>
        ...
        {/* Bottom ticker */}
        <div
          className={`mt-16 pt-8 border-t border-foreground/10 flex flex-wrap items-center gap-x-12 gap-y-4 text-sm font-mono text-muted-foreground transition-all duration-1000 delay-500 ${
            isVisible ? "opacity-100" : "opacity-0"
          }`}
        >
          ...
          <span>Clerk</span>
          <span>EdgeStore</span>
          <span className="text-foreground">Guest mode included</span>
        </div>
      </div>
    </section>
  );
